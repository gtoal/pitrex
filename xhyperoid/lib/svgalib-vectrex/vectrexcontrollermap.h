...
#define PORT1BUT1	SCANCODE_F1
#define PORT1BUT2	SCANCODE_S
#define PORT1BUT3	SCANCODE_TAB
#define PORT1BUT4	SCANCODE_SPACE
#define PORT2BUT1	SCANCODE_F1
#define PORT2BUT2	SCANCODE_S
#define PORT2BUT3	SCANCODE_TAB
