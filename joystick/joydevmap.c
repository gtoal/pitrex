...
//#include "config.h"
#define PACKAGE_STRING "joydevmap"
#define PACKAGE_VERSION "0.1"
#define PACKAGE_BUGREPORT "https://www.sthu.org/code/joydevmap.html"
...
int main(int argc, char** argv)
{
	...
	char* argSetAxismap=NULL;
	char* argSetButtonmap=NULL;
	...
	if( !dev )
	{
		fprintf(stderr, "You need to specify a device such as: --dev /dev/input/js0\n");
		return EXIT_INVARG;
	}
