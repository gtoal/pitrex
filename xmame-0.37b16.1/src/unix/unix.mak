...
LIBS.dispmanx	= `$(SDL_CONFIG) --libs` -L$(SDKSTAGE)/opt/vc/lib -lbcm_host -lGLESv2 -lEGL -lglib-2.0 
...
CFLAGS.dispmanx = -I/opt/vc/include -I/opt/vc/include/interface/vcos/pthreads -I/opt/vc/include/interface/vmcs_host/linux -DDISPMANX `$(SDL_CONFIG) --cflags`
CFLAGS.photon2	=
...
OBJS  += $(subst $(OBJ)/vidhrdw/vector.o, ,$(COREOBJS)) $(DRVLIBS) \
 ...
 $(OBJ)/unix.$(DISPLAY_METHOD)/memcpy.o $(OBJ)/unix.$(DISPLAY_METHOD)/memset.o
...
##############################################################################
$(NAME).$(DISPLAY_METHOD).$(MAME_VERSION): $(OBJS)
...
$(OBJ)/cpu/cyclone/cyclone.o: src/cpu/cyclone/cyclone.s
	@echo 'Assembling $< ...'
	$(CC_COMPILE) $(CC) $(MY_CFLAGS) -o $@ -c $<

$(OBJ)/cpu/drz80/drz80.o: src/cpu/drz80/drz80.s
	@echo 'Assembling $< ...'
	$(CC_COMPILE) $(CC) $(MY_CFLAGS) -o $@ -c $<
...
$(OBJ)/unix.$(DISPLAY_METHOD)/memset.o: src/unix/memset.s
	@echo 'Assembling $< ...'
	$(CC_COMPILE) $(CC) $(MY_CFLAGS) -o $@ -c $<
