...
CPU=$(strip $(findstring DRZ80@,$(CPUS)))
ifneq ($(CPU),)
OBJDIRS += $(OBJ)/cpu/drz80
CPUDEFS += -DHAS_DRZ80=1
CPUOBJS += $(OBJ)/cpu/drz80/drz80.o
CPUOBJS += $(OBJ)/cpu/drz80/drz80_z80.o
$(OBJ)/cpu/drz80/drz80_z80.o: drz80_z80.c drz80_z80.h
$(OBJ)/cpu/drz80/drz80.o: drz80.s drz80.h
else
...
CPU=$(strip $(findstring CYCLONE@,$(CPUS)))
ifneq ($(CPU),)
OBJDIRS += $(OBJ)/cpu/cyclone
CPUDEFS += -DHAS_CYCLONE=1
CPUOBJS += $(OBJ)/cpu/cyclone/cyclone.o
CPUOBJS += $(OBJ)/cpu/cyclone/c68000.o
$(OBJ)/cpu/cyclone/cyclone.o: cyclone.s
$(OBJ)/cpu/cyclone/c68000.o: c68000.c c68000.h cyclone.h
else
CPUDEFS += -DHAS_CYCLONE=0
endif
