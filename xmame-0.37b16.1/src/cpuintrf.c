...
#endif
#if (HAS_DRZ80)
	CPU1(DRZ80,	   drz80, 	 1,255,1.00,DRZ80_IGNORE_INT,  DRZ80_IRQ_INT,  DRZ80_NMI_INT,  8, 16,	  0,16,LE,1, 4	),
#endif
#if (HAS_8080)
...
#endif
#if (HAS_CYCLONE)
	CPU0(CYCLONE,  cyclone,  8, -1,1.00,cyclone_INT_NONE,  -1,			    -1,			   16,24bew,  0,24,BE,2,10  ),
#endif
#if (HAS_M68010)
	...
	if (num != INT_TYPE_NONE(cpunum))
	{
		...
		else
		{
...
#endif
#if (HAS_DRZ80)
			case CPU_DRZ80:				irq_line = 0; LOG(("DRZ80 IRQ\n")); break;
#endif
#if (HAS_8080)
			case CPU_8080:
				switch (num)
			...
			case CPU_CYCLONE:
				...
				default:				irq_line = 0; LOG(("Cyclone unknown\n"));
				}
				/* until now only auto vector interrupts supported */
