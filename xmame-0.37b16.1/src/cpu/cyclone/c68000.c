...
#ifdef WRITEWORD_WORKAROUND
static void writeword_a24_d16(offs_t address, data32_t data)
{
	cpu_writemem24bew_word(address, data&0xffff);
}
#endif
...
void cyclone_reset(void *param)
{
	...
	cyclone.regs.read32 = (unsigned int (*)(unsigned int)) /* cpu_readmem24bew_dword */ readlong_a24_d16;
	cyclone.regs.write8 = (void (*)(unsigned int, unsigned char)) cpu_writemem24bew;
#ifdef WRITEWORD_WORKAROUND
	cyclone.regs.write16= (void (*)(unsigned int, unsigned int)) writeword_a24_d16;
#else
	cyclone.regs.write16= (void (*)(unsigned int, unsigned short)) cpu_writemem24bew_word;
#endif
	cyclone.regs.write32= (void (*)(unsigned int, unsigned int)) /* cpu_writemem24bew_dword */ writelong_a24_d16;
	...
	cyclone.regs.fetch32 = (unsigned int (*)(unsigned int)) /* cpu_readmem24bew_dword */ readlong_a24_d16;
    ...
    switch( regnum )
    {
		...
		default:
			if( regnum < REG_SP_CONTENTS )
			{
				...
				if( offset < 0xfffffd )
					return /* cpu_readmem24bew_dword */ readlong_a24_d16 ( offset );
            }
    }
    return 0;
}
